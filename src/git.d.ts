// Vendored from microsoft/vscode, branch release/1.135:
//   extensions/git/src/api/git.d.ts
// Licensed under the MIT License, see the header below.
// Local edit: dropped the unused `SourceControlHistoryItem` import, which
// @types/vscode 1.90 does not export.
